...
function gwarr_install_table() {
    ...
    // Columns added in v1.7.1 (source/wc_order_id/wc_item_id/claimed_at) are
    ...
    // Warranty claims (v1.7.1) — one row per customer claim against a warranty.
